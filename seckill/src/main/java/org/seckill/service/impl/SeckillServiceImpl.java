...
public class SeckillServiceImpl implements SeckillService {
    ...
    // md5盐值字符串，用户混淆MD5
    private final String slat = "！@#￥%asdfghjkl&*WSXCFRTGBNJ7539651%^&*(";
     ...
     *  2: 保证事物方法的执行时间尽可能短，不要穿插其他网络操作RPC/HTTP请求或者玻璃刀事务方法外部。
        ...
        try {
            ...
            if (insertCount <= 0) {
                ...
                if (updateCount <= 0) {
                    ...
                    return new SeckillExecution(seckillId, SeckillStatEnum.SUCCESS, sucessKilled);
                }
            }
